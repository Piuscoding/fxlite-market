...
const sendEmail = async ( fullname, email,  password ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      to:email,
      subject: 'Welcome to FXLITE',
      html: `<p>Hello  ${fullname},<br>You are welcome to Fxlite, we will help you make profit from the financial market after trading. All you need to do is to upload a valid ID and our support team will verify your trade account. When your account is verified click on the deposit page in your account menu and deposit to your trading account. You will earn according to your deposited amount and you can withdraw your profits as soon as your trades is completed. Good luck and we are waiting to get testimonies from you.

      Please note that your deposit is with the wallet address provided by Maxtrade-Exchange trading Platform, do not invest to any copied wallet address or bank details provided by any account manager or third party other than that provided by Fxlite, hence your deposit is invalid.<br><br>
      
      <br><br>Best Regards,
      Management<br><br>
      
      @ 2022 Fxlite-Markets | All right reserved..<br><br>
